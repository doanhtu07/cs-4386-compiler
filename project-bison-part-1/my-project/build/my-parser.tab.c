...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_WRITEINT = 22,                  /* WRITEINT  */
  YYSYMBOL_READINT = 23,                   /* READINT  */
  YYSYMBOL_IDENTIFIER = 24,                /* IDENTIFIER  */
  YYSYMBOL_NUMBER = 25,                    /* NUMBER  */
  YYSYMBOL_BOOLLIT = 26,                   /* BOOLLIT  */
...
{
       0,    43,    43,    51,    53,    58,    60,    64,    66,    71,
      73,    75,    77,    81,    83,    87,    94,    96,   101,   107,
...
{
  "\"end of file\"", "error", "\"invalid token\"", "LP", "RP", "ASGN",
  "SC", "OP2", "OP3", "OP4", "IF", "THEN", "ELSE", "START", "END", "WHILE",
  "DO", "PROGRAM", "VAR", "AS", "INT", "BOOL", "WRITEINT", "READINT",
  "IDENTIFIER", "NUMBER", "BOOLLIT", "$accept", "program", "declarations",
...
{
      -6,    10,    12,    -9,     5,   -34,    11,    -8,   -11,     0,
       0,     0,     8,    15,    25,   -34,   -34,   -34,   -34,   -34,
     -34,    26,     0,   -34,   -34,   -34,    22,    27,    29,    28,
      18,   -34,    -3,   -34,    -8,    10,    34,    -8,     0,     0,
       0,    -8,   -34,   -34,   -34,   -34,   -34,    30,   -34,   -34,
     -34,    31,    -8,    32,   -34,   -34,   -34
};
...
static const yytype_int8 yydefact[] =
{
       ...
       6,     0,     0,    27,    28,    29,     0,    21,    23,    25,
       0,    19,     0,     2,     8,     4,     0,     8,     0,     0,
       0,     8,    14,    13,     7,     3,    26,    17,    20,    22,
      24,     0,     8,     0,    18,    16,    15
};
...
{
      22,    44,     9,    22,    47,    30,    31,    10,    51,    19,
      20,     1,     5,    32,    11,     6,    12,    36,     7,    55,
      42,    23,    24,    25,    23,    24,    25,    43,     3,    33,
       8,    34,    35,    37,    41,    40,    38,    39,    46,    45,
      48,    50,    52,     0,     0,    54,    56,     0,    49
};

static const yytype_int8 yycheck[] =
{
       3,    34,    10,     3,    37,    10,    11,    15,    41,    20,
      21,    17,     0,     5,    22,    24,    24,    22,    13,    52,
      23,    24,    25,    26,    24,    25,    26,    32,    18,    14,
      19,     6,     6,    11,    16,     7,     9,     8,     4,    35,
      38,    40,    12,    -1,    -1,    14,    14,    -1,    39
};
...
{
       0,    17,    28,    18,    29,     0,    24,    13,    19,    10,
      15,    22,    24,    31,    32,    33,    34,    36,    37,    20,
...
#line 1128 "./build/my-parser.tab.c"
